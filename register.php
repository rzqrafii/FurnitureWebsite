<?php
	...
	if (isset($_POST['submit']))
	{
		...
		// $insert =" INSERT INTO whatsup values ('NULL','$user','$pass','$filename','$harga')";
		$sisip = mysqli_query($con,"INSERT INTO tb_cust VALUES (NULL,
			'$nama',
			'$nope',
			'$email',
			'$pass')");
...
<div class="container">
		<div class="login">
			...
			<div class="login-mail">
				...
				<div class="login-mail">
					<input type="text" placeholder="Phone Number" required="" name="nohp">
