...
<div class="container">
		<div class="head">
			<div class=" logo">
					...
					<img src="images/logodekor-01.png" alt="" style="float: left; width: 20%; margin-top: 5.5%;">
					</a>	
	...
	<div class="header-top">
		<div class="container">
			<div class="col-sm-7 header-social">		
					<ul style="padding-bottom: 5px;"><!-- 
						<li style="color: white;font-size: 10px; padding-bottom: 5px;">0896-6885-8418</li> -->
						<li class="popup" onclick="myFunction()" style="color: white;font-size: 10px; ">
							<span class="popuptext" id="myPopup">
							Pastikan untuk memeriksa kondisi produk yang dibeli pada saat menerima pesanan <br><br>
							Jika melihat adanya kerusakan pada produk, maka dimohon untuk menolak penerimaan produk dan segera konfirmasi pada customer service <br><br>
							Jika kerusakan terjadi setelah menerima barang dalam jangka waktu yang ditentukan maka pelanggan dapat menghubungi kami</span>
							<img src="images/365-01.png" style="width: 12.5%; height: auto;">&nbspGaransi 365 Hari

						</li>

						<li class="popup" onclick="myFunction1()" style="color: white;font-size: 10px;">
							<span class="popuptext1" id="myPopup1">
							Berlaku untuk kartu kredit <b>Joni Pay</b> dan Harus berlangganan <b>dekoryuk</b> selama 1 tahun</span><br>
							<img src="images/0-01.png" style="width: 12.5%; height: auto; ">&nbspCicilan 0%
						</li>

						<li class="popup" onclick="myFunction2()" style="color: white;font-size: 10px; ">
							<span class="popuptext2" id="myPopup2">
							Berlaku untuk Area <b>JABODETABEK</b><br><br>
							Berlaku untuk <b>semua</b>Furniture <br><br>
							Tidak ada minimal pembelian</span>
							<img src="images/free-01.png" style="width: 12.5%; height: auto; ">&nbspPengiriman Gratis*</li>
						<!-- facebook -->
						<!-- <li><a href="https://twitter.com/rafiirzq" target="_blank"><i></i></a></li> -->
						<!-- twitter -->
						<!-- <li><a href="https://www.facebook.com/rafi.rizqullah.7" target="_blank"><i class="ic1"></i></a></li>
		...
		<div class="col-sm-3 col-md-offset-2  header-login">
					<ul style="margin-top: 10px;">
						<li><a href="login.php">Login</a></li>
						<li> <p style="color: white;">&nbsp&nbsp|&nbsp&nbsp</p></li>
			...
			<div class="col-sm-2 search-right">
				...
				<li>
					...
					<div class="cart box_1">
						...
						<p><a href="logout.php" class="simpleCart_empty"><?php echo $_SESSION['name']?></a></p>
					</div>
					<div class="clearfix"> </div>
...
<!--banner-->
<div id="banner">
	<img src="images/slide_dekor-01-01.jpg" style="width: 100%;">
</div>
<!-- <div class="banner">
<div class="container">
					...
					<div class="col-md-6 col-md">
						<div class="col-1">
						 <a href="#" class="b-link-stroke b-animate-go  thickbox">
		   					<img src="images/paketA-02.jpg" class="img-responsive" alt=""/>
		   					<div class="b-wrapper1 long-img"><p class="b-animate b-from-right    b-delay03 ">Lampu Gantung</p>
		   					<label class="b-animate b-from-right    b-delay03 "></label><h3 class="b-animate b-from-left    b-delay03 ">Trendy</h3></div></a>
						...
						<div class="col-2">
							...
							<a href="product.php" class="buy-now">Buy Now</a>
						</div>
					</div>
					<div class="col-md-6 col-md1">
						<div class="col-3">
							<a href="single.html"><img src="images/paketD-02.jpg" class="img-responsive" alt="">
							<div class="col-pic">
								<label></label>
								<h5>Dekorasi Rumah</h5>
							</div></a>
						</div>
						<div class="col-3">
							<a href="single.html"><img src="images/paketB-02.jpg" class="img-responsive" alt="">
							<div class="col-pic">
								<label></label>
								<h5>Ruang Makan</h5>
							</div></a>
						...
						<div class="col-3">
							<a href="single.html"><img src="images/paketC-02-02.jpg" class="img-responsive" alt="">
							<div class="col-pic">
								<label></label>
								<h5>Ruang Tamu</h5>
							</div></a>
...
// 	$file_star = "../server-img/img-gallery/5-stars.png";
	...
	curl_setopt($curl, CURLOPT_URL, "http://localhost/SourceCodeWebsite_Dekoryuk/server/serviceFurnitureTopProduct.php");
